 ...
 */
final class Version20231014130758 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trabajador_trabajo (trabajador_id INT NOT NULL, trabajo_id INT NOT NULL, INDEX IDX_C431F99EC3656E (trabajador_id), INDEX IDX_C431F99287A134A (trabajo_id), PRIMARY KEY(trabajador_id, trabajo_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
